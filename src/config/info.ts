...
const info: Record<Locale, Info> = {
  ...
  zh: {
    ...
    bio: `翁荻研究员现任<a href="http://www.cst.zju.edu.cn/" target="_blank">浙江大学软件学院</a>平台“百人计划”研究员、博士生导师。长期从事<b>交互式数据治理与人机协同数据分析</b>等方面研究，在 IEEE VIS、ACM CHI、IEEE TVCG 等 CCF-A 类期刊和会议上发表论文 30 余篇，被引超过 1000 次，并获得 10 项发明专利授权。连续两年担任本领域 CCF-A 类旗舰会议 IEEE VIS 2023-2025 程序委员会委员，并受邀主持 IEEE VIS 2023、ChinaVis 2023、PacificVis 2024 等重要学术会议的地理可视化、可视分析相关分论坛。现任中国图象图形学学会可视化与可视分析专委会委员、中国计算机学会计算机辅助设计与图形学专委会执行委员，以及多个国内外知名期刊/会议审稿人。`,
