...
export default {
  ...
  bio: `👋 Hi, I'm Di Weng (<img style="display: inline-block; height: 1.1rem" src="/img/cn_name.avif" alt="翁荻" />), a tenure-track assistant professor (ZJU 100 Young Professor Program) at <a href="http://www.cst.zju.edu.cn/">School of Software Technology, Zhejiang University</a>. My research interest lies in information visualization and visual analytics, focusing on <u>interactive data transformation and spatiotemporal data visual analysis</u>. I've published <u>over 20 peer-reviewed papers</u> in top (CCF-A) computer science conferences and journals, including IEEE VIS, ACM CHI, IEEE TVCG, ACM KDD, etc, and served as <u>program committee members</u> for IEEE VIS 2023-2024, ChinaVis 2022-2024, <u>session chairs</u> for IEEE VIS 2023 and IEEE PacificVis 2024, as well as reviewers for many journals and conferences. For more information, please check out <a href="/vita">my vita</a>.`,
  footnote: `This site was based on <a href="https://github.com/w1ndy/simplistic-researcher-portfolio" target="_blank">this theme</a> and powered by Solid.js and Cloudflare Pages. Last updated: ${BUILD_TIMESTAMP}.`,
}
