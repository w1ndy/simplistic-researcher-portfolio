...
export default {
  ...
  bio: `Hi, I'm Di Weng (翁荻), a tenure-track assistant professor at School of Software Technology, Zhejiang University. My research interest lies in information visualization and visual analytics, focusing on <b>interactive data transformation and spatiotemporal data analysis</b>. I've published over a dozen peer-reviewed papers in prestigious computer science conferences and journals, including IEEE VIS, ACM CHI, IEEE TVCG, etc, and served as program committee members for IEEE VIS 2023, ChinaVis 2022 and 2023, as well as reviewers for many journals and conferences.`,
  footnote: `This theme was inspired by <a href="https://homes.cs.washington.edu/~jheer/" target="_blank">Prof. Jeffery Heer</a>. The source of this site can be found on <a href="https://github.com/w1ndy/simplistic-researcher-portfolio" target="_blank">GitHub</a>. Last updated: ${
    (window as any).BUILD_TIMESTAMP
  }.`,
}
